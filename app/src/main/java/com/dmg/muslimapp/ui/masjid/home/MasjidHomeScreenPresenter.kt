...
class MasjidHomeScreenPresenter(private var mView: MasjidHomeScreenView?): MasjidHomeScreenPresenterView {
    override fun getListMasjid(lat: String, long: String){
        AndroidNetworking.get(ApiEndPoint.ENDPOINT_NEAR)
                .addQueryParameter("lat", lat)
                .addQueryParameter("long", long)
    ...
    override fun getDetailMasjid(id: String){
        ...
        val data: MasjidList = Gson().fromJson(res.toString() , MasjidList::class.java)
        ...
        /*AndroidNetworking.get(ApiEndPoint.ENDPOINT_NEAR)
                ...
                .getAsJSONArray(object : JSONArrayRequestListener{
                    override fun onResponse(response: JSONArray) {
                        ...
                        val list: MutableList<MasjidList> = Gson().fromJson(response.toString() , Array<MasjidList>::class.java).toMutableList()

                        if(list == null) {
                            //mView.getFailed(responses.getMessage())
                            Log.e("Response", "Data not found")
                        }else{
                            mView?.openDetail(list)
