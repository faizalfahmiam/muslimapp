package com.dmg.muslimapp.ui.custom.viewpager;
...
public class AutoScrollViewPager extends RelativeLayout {
    ...
    public void initPointView(int size,int currentPoint) {
        ...
        for (int i = 0; i < size; i++) {
            ...
            if (i == currentPoint) {
                imageView.setBackgroundResource(R.drawable.selected_item_dot);
            } else {
                imageView.setBackgroundResource(R.drawable.unselected_item_dot);
            }
